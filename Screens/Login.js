                        ...
                        <View style={{ marginTop: 50, margin: 30, paddingLeft: 10 }}>
                            ...
                            <TouchableOpacity>
                                <View style={{ alignItems: 'center', paddingLeft: 150 }}>
                                    <Text style={{ fontWeight: 'bold', fontSize: 16, color: 'black' }}>Forgot Password</Text>
                                </View>
                            </TouchableOpacity>
                            ...
                            <LinearGradient colors={['teal', 'white']}
                                ...
                                <TouchableOpacity onPress={handleuserlogin}>
                                    <Text style={{ alignItems: 'center', paddingTop: 8, paddingLeft: 100, fontSize: 25, color: 'white' }}>Login</Text>
                                </TouchableOpacity>

                                <View style={{ display: 'flex', flexDirection: 'row', top: 20, justifyContent: 'center', }} >
                                    <Text style={{ fontSize: 18, fontWeight: 'bold' }}> Create New Account |</Text>

                                    <TouchableOpacity >
                                        <Text style={{ fontSize: 18, fontWeight: 'bold', color: 'blue' }}   onPress={()=>{navigation.navigate(Signup)}}> Signup</Text>
                                    </TouchableOpacity>
                                </View>
                            </LinearGradient>
